...
| 模块 | 具体结构 | 关键配置 | 状态 / 参数量 |
|------|---------|---------|-------------|
| Thinker | Versper Transformer | 8层, hidden 768, 8/4 KV heads, vocab 6400 | trainable, 63.91M / 198.42M |
| Talker | 4 × Versper blocks | hidden 768, audio vocab 2112, 8 heads, rank-256 | trainable, 47.05M / 114.30M |
